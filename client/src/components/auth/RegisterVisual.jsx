...
import { Code, Users, BookOpen, Trophy, GraduationCap, Rocket, CheckCircle2 } from 'lucide-react';

const RegisterVisual = memo(() => {
  const benefits = [
    ...
    <div className="hidden lg:flex lg:w-3/5 relative bg-gradient-to-br from-primary-dark via-primary to-primary-light">
      ...
      <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16 py-12 h-full text-white">
        ...
        <motion.div
          ...
          className="mb-8 space-y-3 max-w-md"
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <span className="text-white/90 text-sm xl:text-base">{feature}</span>
            </motion.div>
          ))}
        </motion.div>
...
RegisterVisual.displayName = 'RegisterVisual';
